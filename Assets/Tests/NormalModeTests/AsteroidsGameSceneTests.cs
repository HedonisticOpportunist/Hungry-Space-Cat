...
public class AsteroidsGameSceneTests
{
    [UnityTest]
    public IEnumerator MovingBackgroundElementsLoadCorrectly()
    {
        // Arrange 
        SceneManager.LoadScene("Assets/Scenes/NormalMode/AsteroidsGame.unity", LoadSceneMode.Single);
        yield
        return null;

        string[] movingBackgrounds = { "green", "green2" };
    ...
    [UnityTest]
    public IEnumerator EnemyPrefabLoadsCorrectly()
    {
        // Arrange 
        SceneManager.LoadScene("Assets/Scenes/NormalMode/AsteroidsGame.unity", LoadSceneMode.Single);
        yield
        ...
        string enemyPrefabText = "FollowingSpaceshipB";

        // Act 
        var enemyPrefab = GameObject.Find(enemyPrefabText);
