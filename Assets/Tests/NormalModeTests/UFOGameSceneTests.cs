...
public class UFOGameSceneTests
{
    [UnityTest]
    public IEnumerator MovingBackgroundElementsLoadCorrectly()
    {
        // Arrange 
        SceneManager.LoadScene("Assets/Scenes/NormalMode/UFOGame.unity", LoadSceneMode.Single);
        yield
        return null;
    ...
    public IEnumerator OtherGameScriptsPrefabsLoadCorrectly()
    {
        ...
        string[] otherScriptPrefabs = { "UFOGameSpawner", "SceneLoaderManager", "HelperManager", "SpawnBugs" };
