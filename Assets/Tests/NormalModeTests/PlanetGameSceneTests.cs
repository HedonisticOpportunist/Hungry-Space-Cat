...
public class PlanetGameSceneTests
{
    [UnityTest]
    public IEnumerator MovingBackgroundElementsLoadCorrectly()
    {
        // Arrange 
        SceneManager.LoadScene("Assets/Scenes/NormalMode/PlanetGame.unity", LoadSceneMode.Single);
        yield
        return null;

        string[] movingBackgrounds = { "purple", "purple2" };
