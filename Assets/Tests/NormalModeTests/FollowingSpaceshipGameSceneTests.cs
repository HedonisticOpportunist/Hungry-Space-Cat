...
public class FollowingSpaceshipGameSceneTests
{
    [UnityTest]
    public IEnumerator MovingBackgroundElementsLoadCorrectly()
    {
        // Arrange 
        SceneManager.LoadScene("Assets/Scenes/NormalMode/FollowingSpaceshipGame.unity", LoadSceneMode.Single);
        yield
        return null;
    ...
    public IEnumerator EnemyPrefabLoadsCorrectly()
    {
        ...
        string enemyPrefabText = "FollowingSpaceship";
